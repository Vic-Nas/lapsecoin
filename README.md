...
| `LAPSECOIN_DRAW_WINDOW_SECONDS` | `10` | How long a height keeps accepting a better same-height block after one is adopted. Work on the next height continues throughout, so this is not a pause |
